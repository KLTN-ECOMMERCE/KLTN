...
final viewedProductsDataProvider = Provider(
  (ref) async {
    final ApiProduct apiProduct = ApiProduct();
    final listProductsId = ref.watch(viewedProductsProvider);
    List<ProductItem> viewedProductsData = [];
    ...
    try {
      for (var productId in listProductsId) {
        ...
        viewedProductsData.add(productItem);
      }
      return viewedProductsData;
    } catch (e) {
